  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text('Tanbir Coding',style: Theme.of(context).textTheme.bodyLarge,),
        const SizedBox(
        ...
        Row(
          children: [
            ...
            Text("+88019371713",style: Theme.of(context).textTheme.bodyMedium,)
          ],
        ),
        const SizedBox(
          height: TSizes.spaceBtwItems / 2,
        ...
        Row(
          children: [
            ...
            Text("DokinhKhan Ainusbag, Dhaka-1230",style: Theme.of(context).textTheme.bodyMedium,softWrap: true,)
          ],
        ),
        const SizedBox(
          height: TSizes.spaceBtwItems / 2,
